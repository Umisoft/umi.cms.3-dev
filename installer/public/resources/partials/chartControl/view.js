                ...
                $.ajax({
                    ...
                    beforeSend: function(){
                        $('.umi-counter-period').after(function(){
                            ...
                            return '<div class="umi-counter-content umi-loader"><i class="animate animate-loader-40" style="float:left"></i><h3 style="float:left; color: #4C617D;">Идет загрузка данных...</h3></div>';
                        });
                    },
