...
return array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'infoblock',
      'guid' => 'ba8f157e-c774-4510-9c3d-f6fee9e4e1ec',
      'displayName' => 'Общие',
    ),
    'data' => 
    array (
      ...
      array (
        0 => 'string',
        1 => '<p>Телефон в Санкт-Петербурге: +7 (812) 309-03-15</p>',
      ),
      'phoneNumber#en-US' => 
      array (
        0 => 'NULL',
      ...
      array (
        0 => 'string',
        1 => '<h1 class="blog-title">Demo lite twig</h1><p class="lead blog-description">Blank-шаблон созданный на Umicms 3</p>',
      ),
      'logo#en-US' => 
      array (
        0 => 'string',
        1 => '<h1 class="blog-title">Demo lite twig</h1><p class="lead blog-description">Blank-template create on Umicms 3</p>',
      ),
      'copyright#ru-RU' => 
      array (
        0 => 'string',
        1 => '<p>Демо сайт разработан на <a href="http://getbootstrap.com">Bootstrap</a> компанией <a href="http://umi-cms.ru/">umi-cms.ru</a></p>',
      ),
      'copyright#en-US' => 
      array (
        0 => 'string',
        1 => '<p>Demo site build for <a href="http://getbootstrap.com">Bootstrap</a> by <a href="http://umi-cms.ru/">umi-cms.ru</a></p>',
      ),
      'counter#ru-RU' => 
      array (
        0 => 'NULL',
