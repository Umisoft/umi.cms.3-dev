        ...
        <div class="content-inner">
            <div class="container-fluid">
                ...
                <div class="comment">
                    ...
                    <xsl:apply-templates select="document(concat('widget://blog.comment.tree?blogPost=', page/@guid, '&amp;options%5Bfields%5D=contents,publishTime'))" mode="blog.comments.tree">
