define(['App'], function(UMI) {
    ...
    return function() {
        UMI.FormRadioElementMixin = Ember.Mixin.create(UMI.FormElementMixin, {
            classNames: ['small-12', 'large-4'],

            template: Ember.Handlebars.compile('{{view "radioElement" object=view.object meta=view.meta}}')
        });
