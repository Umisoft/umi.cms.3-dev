...
return [
    ...
    SettingsComponent::OPTION_SETTINGS_CONFIG_ALIAS => '~/project/site/configuration/settings.config.php',

    SettingsComponent::OPTION_FORMS => [
        'settings' => '{#lazy:~/project/site/settings/common/form/settings.php}'
    ],
