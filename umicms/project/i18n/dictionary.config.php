...
return [
        ...
        'project.admin.rest.settings.service' => '{#lazy:~/project/module/service/settings/i18n/dictionary.config.php}',
        'project.admin.rest.settings.service.backup' => '{#lazy:~/project/module/service/settings/backup/i18n/dictionary.config.php}',
        'project.admin.rest.settings.seo' => '{#lazy:~/project/module/seo/settings/i18n/dictionary.config.php}',
        'project.admin.rest.settings.seo.megaindex' => '{#lazy:~/project/module/seo/settings/megaindex/i18n/dictionary.config.php}',
        'project.admin.rest.settings.seo.yandex' => '{#lazy:~/project/module/seo/settings/yandex/i18n/dictionary.config.php}',
        'project.admin.rest.settings.statistics' => '{#lazy:~/project/module/statistics/settings/i18n/dictionary.config.php}',
        'project.admin.rest.settings.statistics.metrika' => '{#lazy:~/project/module/statistics/settings/metrika/i18n/dictionary.config.php}',
        'project.admin.rest.settings.users' => '{#lazy:~/project/module/users/settings/i18n/dictionary.config.php}',

        'project.admin.rest.settings.forms' => '{#lazy:~/project/module/forms/settings/i18n/dictionary.config.php}',
        'project.admin.rest.settings.forms.captcha' => '{#lazy:~/project/module/forms/settings/captcha/i18n/dictionary.config.php}',
