...
return [
    ...
    'project.admin.rest.dispatches.template'          => '{#lazy:~/project/module/dispatches/admin/template/i18n/dictionary.config.php}',
    'project.admin.rest.dispatches.release'           => '{#lazy:~/project/module/dispatches/admin/release/i18n/dictionary.config.php}',
    'project.admin.rest.dispatches.releasestatus'     => '{#lazy:~/project/module/dispatches/admin/releasestatus/i18n/dictionary.config.php}',
    'project.admin.rest.dispatches.unsubscription'    => '{#lazy:~/project/module/dispatches/admin/unsubscription/i18n/dictionary.config.php}',
    ...
    'collection.dispatch'                             => '{#lazy:~/project/module/dispatches/configuration/dispatch/i18n/dictionary.config.php}',
    'collection.dispatchSubscriber'                   => '{#lazy:~/project/module/dispatches/configuration/subscriber/i18n/dictionary.config.php}',
    'collection.dispatchTemplate'                     => '{#lazy:~/project/module/dispatches/configuration/template/i18n/dictionary.config.php}',
    'collection.dispatchUnsubscription'               => '{#lazy:~/project/module/dispatches/configuration/unsubscription/i18n/dictionary.config.php}',
    'collection.dispatchReleaseStatus'                => '{#lazy:~/project/module/dispatches/configuration/releasestatus/i18n/dictionary.config.php}',
