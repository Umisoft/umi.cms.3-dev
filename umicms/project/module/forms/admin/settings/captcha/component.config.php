...
return [
    ...
    SettingsComponent::OPTION_SETTINGS_CONFIG_ALIAS => '~/project/configuration/captcha.config.php',

    SettingsComponent::OPTION_FORMS => [
        'settings' => '{#lazy:~/project/module/forms/admin/settings/captcha/form/settings.php}'
    ],
