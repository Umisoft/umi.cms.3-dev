...
return [
    ...
    DefaultSettingsComponent::OPTION_SETTINGS_CONFIG_ALIAS => '~/project/module/seo/configuration/yandex/model.settings.config.php',

    DefaultSettingsComponent::OPTION_FORMS => [
        'settings' => '{#lazy:~/project/module/seo/settings/yandex/form/settings.php}'
    ],
