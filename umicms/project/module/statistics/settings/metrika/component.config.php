...
return [
    ...
    DefaultSettingsComponent::OPTION_SETTINGS_CONFIG_ALIAS => '~/project/module/statistics/configuration/metrika/model.settings.config.php',

    DefaultSettingsComponent::OPTION_FORMS => [
        'settings' => '{#lazy:~/project/module/statistics/settings/metrika/form/settings.php}'
    ],
