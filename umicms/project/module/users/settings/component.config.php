...
return [
    ...
    DefaultSettingsComponent::OPTION_SETTINGS_CONFIG_ALIAS => '~/project/module/users/configuration/user/collection.settings.config.php',

    DefaultSettingsComponent::OPTION_FORMS => [
        'settings' => '{#lazy:~/project/module/users/settings/form/settings.php}'
    ],
