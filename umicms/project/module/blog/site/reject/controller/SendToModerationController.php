...
class SendToModerationController extends BaseCmsController
{
    ...
    protected function buildForm()
    {
        ...
        return $this->module->post()->getForm(BlogPost::FORM_MODERATE_POST, $this->blogPost->getTypeName());
    }
    ...
    {
        $this->blogPost->status = $this->module->postStatus()->get(PostStatus::GUID_NEED_MODERATION);
        $this->commit();
    }
}
