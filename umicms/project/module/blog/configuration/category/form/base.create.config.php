    ...
    'elements' => [
        ...
        'common' => [
            ...
            'elements' => [
                ...
                BlogCategory::FIELD_PAGE_SLUG => [
                    'type' => Text::TYPE_NAME,
                    'label' => BlogCategory::FIELD_PAGE_SLUG,
                    'options' => [
                        'dataSource' => BlogCategory::FIELD_PAGE_SLUG
                    ],
                ],
                BlogCategory::FIELD_ACTIVE => [
                    'type' => Checkbox::TYPE_NAME,
                    'label' => BlogCategory::FIELD_ACTIVE,
                    'options' => [
                        'dataSource' => BlogCategory::FIELD_ACTIVE
                    ],
                ]
            ]
        ],
