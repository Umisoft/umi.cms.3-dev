...
return [
    'name'   => 'dispatch',
    'models' => [
        'dispatch'              => '~/project/module/dispatch/configuration/dispatch',
        'subscriber'            => '~/project/module/dispatch/configuration/subscriber',
        ...
        'unsubscribedispatches' => '~/project/module/dispatch/configuration/unsubscribe',
    ]
];